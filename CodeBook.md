...
##GCD_Project_result5.txt contains the data set captured using the write.table() function

In order to reproduce the results presented in GCD_Project_result5.txt, please refer to README.md which outlines the steps involved to generate it.
